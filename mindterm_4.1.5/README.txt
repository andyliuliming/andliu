...
================
  ...
  as an applet, and it works with any JRE implementing Java 1.5 or
...
=====================
  ...
  This will produce a mindterm.jar-file. Other useful targets are:
    ...
    mindterm_minimal_ssh2.jar - the minimum of classes needed to support
               the setup and use SSH2 connections

  MindTerm requires Java 1.5 or later to build. The generated binaries
...
======================
  ...
  http://www.cryptzone.com/products/agmindterm/, or built using "ant doc". 
  The "ant doc" method will create a directory called javadocs where the API
...
=======
  ...
  Support for the free version of MindTerm is only available through
  the MindTerm forum at

     http://forum.appgate.com/

  We at Cryptzone do read this forum but do not promise to answer all 
  questions.
...
=================
  ...
  * Key exchange support: Diffie-Hellman group-exchange protocol,
    Diffie-Hellman group1-sha1 & Diffie-Hellman Elliptic Curve
