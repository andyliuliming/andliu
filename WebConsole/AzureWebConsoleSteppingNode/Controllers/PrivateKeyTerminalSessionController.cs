...
namespace AzureTerminalWebConsole.Controllers
{
    ...
    {
        public HttpResponseMessage Get(String hostName, String userName, String privateKey, String port, String columns, String rows)
        {
            if (HttpContext.Current.IsWebSocketRequest)
            {
                HttpContext.Current.AcceptWebSocketRequest(new SSHSocketHandler(hostName, userName, privateKey, port, columns, rows));
            }
        ...
        private class SSHSocketHandler : WebSocketHandler
        {
            ShellStream stream;
            bool firstTime = true;
            public SSHSocketHandler(String hostName, String userName, String privateKey, String port, String columns, String rows)
            {
