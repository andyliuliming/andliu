...
class EncryptionConfig(object):
    ...
    def save_bek_filename(self, passphrase_file_name):
        self.passphrase_file_name = passphrase_file_name
    ...
    def commit(self):
        ...
        parameters = ConfigKeyValuePair(CommonVariables.SecretUriKey,self.secret_uri)
