...
$ProductServiceDiagnosticConfig = "$currentFolder/$ProductAzureServiceName/bin/$buildType/app.publish/Extensions/PaaSDiagnostics.$ProductServiceRoleName.PubConfig.xml"
