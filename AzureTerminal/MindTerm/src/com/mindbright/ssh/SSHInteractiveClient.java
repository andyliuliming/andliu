...
public final class SSHInteractiveClient extends SSHClient
    ...
    public boolean installLogo() {
        ...
        t.setLogo(_logo, -1, -1, _logo.getWidth(null), _logo.getHeight(null));
        return true;
    }

    public static ByteArrayOutputStream readResource(String name) {
        InputStream in = SSHInteractiveClient.class.getResourceAsStream(name);
    ...
    public Component getDialogParent() {
        if (parent != null)
            return parent;
        return (menus != null) ? ((SSHMenuHandlerFull)menus).parent : null;
    }
    ...
    /**
     * Get the local MIT_MAGIC_COOKIE to use for X11 connections. This
     * procedure uses xauth to get the cookie for $DISPLAY if
     * possible.
     *
