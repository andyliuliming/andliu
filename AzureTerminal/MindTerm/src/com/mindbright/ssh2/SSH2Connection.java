...
public final class SSH2Connection implements Runnable {
    ...
    void terminate() {
	ArrayList<SSH2Channel> chs = new ArrayList<SSH2Channel>();
	synchronized (this) {
	    if(connector != null) {
		connector.stop();
	    }
