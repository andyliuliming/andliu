...
public class SSH2Preferences {
    ...
    public static final String TRANSPORT_CACHE_SIZE = "transport-cache-sz";
    public static final String TRANSPORT_CACHE_SIZE_TOTAL = "transport-cache-sz-total";
    public static final String SFTP_TIMEOUT   = "sftp-timeout";
	...
	defaultProperties.put(TRANSPORT_CACHE_SIZE, "4");
	defaultProperties.put(TRANSPORT_CACHE_SIZE_TOTAL, "256");
	defaultProperties.put(SFTP_TIMEOUT, "30");
