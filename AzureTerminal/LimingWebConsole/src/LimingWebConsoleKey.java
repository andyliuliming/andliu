...
public class LimingWebConsoleKey extends Applet {
	/**
	 * 
	 */
	...
	public void InitizlizeConnection() throws JSchException {
		...
		// String passwd =
		// "andy";//JOptionPane.showInputDialog("Enter password");
	...
	public LimingWebConsoleKey() throws IOException, JSchException {
		setLayout(null);
