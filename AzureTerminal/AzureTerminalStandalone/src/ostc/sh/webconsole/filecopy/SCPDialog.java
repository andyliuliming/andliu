...
public class SCPDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public SCPDialog(WebConsoleConnection c) {
		...
		sendToRemoteButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e){
				...
				for(String selectedItem : selectedItems){
					...
					util.CopyTo(connection.GetSession(), filePath, remoteFile);
				}			
			}
		});
		...
		sendToLocalButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				for(String selectedItem : selectedItems){
					...
					String remoteFile = remoteCurrentFolder + "/"+selectedItem;
					util.CopyFrom(connection.GetSession(), remoteFile, filePath);
				}	
			}
		});
			...
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					...
					try {
						...
						exec = (ChannelExec) connection.GetSession().openChannel("exec");					
