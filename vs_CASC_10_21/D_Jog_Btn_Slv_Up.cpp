// D_Jog_Btn_Slv_Up.cpp : implementation file
//
...
CD_Jog_Btn_Slv_Up::CD_Jog_Btn_Slv_Up()
{
	IsPressed = FALSE;
}
...
BEGIN_MESSAGE_MAP(CD_Jog_Btn_Slv_Up, CButton)
	//{{AFX_MSG_MAP(CD_Jog_Btn_Slv_Up)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CD_Jog_Btn_Slv_Up message handlers

void CD_Jog_Btn_Slv_Up::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
void CD_Jog_Btn_Slv_Up::OnLButtonDown(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	IsPressed = TRUE; //按钮被按下
	global_slv_up_status=1;
	global_opr_wr_rd=JOG_SLV_UP;
	PostThreadMessage(m_dwThreadId_Wr, WM_UM_JOG_BTN_SLV_UP, NULL, NULL);
	CButton::OnLButtonDown(nFlags, point);
}

void CD_Jog_Btn_Slv_Up::OnLButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	IsPressed = FALSE;	//释放鼠标按钮
	global_slv_up_status=0;
	global_opr_wr_rd=JOG_SLV_UP;
	PostThreadMessage(m_dwThreadId_Wr, WM_UM_JOG_BTN_SLV_UP_STOP, NULL, NULL);
	CButton::OnLButtonUp(nFlags, point);
}

void CD_Jog_Btn_Slv_Up::OnMouseMove(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	CRect rect;
	GetClientRect(rect);
...
void CD_Jog_Btn_Slv_Up::PreSubclassWindow() 
{
...
void CD_Jog_Btn_Slv_Up::SetImageIndex(UINT index)
{
	m_ImageIndex = index;
}

void CD_Jog_Btn_Slv_Up::SetImageList(CImageList *pImage)
{
	m_pImagelist = pImage;
}
