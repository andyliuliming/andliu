// D_Jog_Btn_Slv_Dn.cpp : implementation file
//
...
CD_Jog_Btn_Slv_Dn::CD_Jog_Btn_Slv_Dn()
{
	IsPressed = FALSE;
}
...
BEGIN_MESSAGE_MAP(CD_Jog_Btn_Slv_Dn, CButton)
	//{{AFX_MSG_MAP(CD_Jog_Btn_Slv_Dn)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CD_Jog_Btn_Slv_Dn message handlers

void CD_Jog_Btn_Slv_Dn::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
...
void CD_Jog_Btn_Slv_Dn::OnLButtonDown(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	IsPressed = TRUE; //按钮被按下
	global_slv_dn_status=1;
	global_opr_wr_rd=JOG_SLV_DN;
	PostThreadMessage(m_dwThreadId_Wr, WM_UM_JOG_BTN_SLV_DN, NULL, NULL);
	CButton::OnLButtonDown(nFlags, point);
}

void CD_Jog_Btn_Slv_Dn::OnLButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	IsPressed = FALSE;	//释放鼠标按钮
	global_slv_dn_status=0;
	global_opr_wr_rd=JOG_SLV_DN;
	PostThreadMessage(m_dwThreadId_Wr, WM_UM_JOG_BTN_SLV_DN_STOP, NULL, NULL);
	CButton::OnLButtonUp(nFlags, point);
}

void CD_Jog_Btn_Slv_Dn::OnMouseMove(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	CRect rect;
	GetClientRect(rect);
...
void CD_Jog_Btn_Slv_Dn::PreSubclassWindow() 
{
...
void CD_Jog_Btn_Slv_Dn::SetImageIndex(UINT index)
{
	m_ImageIndex = index;
}

void CD_Jog_Btn_Slv_Dn::SetImageList(CImageList *pImage)
{
	m_pImagelist = pImage;
}
